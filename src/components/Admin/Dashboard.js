...
import RegistrationForm from "../Front/RegistrationForm";
import { REGISTER_MODAL_OPEN, REGISTER_MODAL_CLOSE } from "../Actions/user";
...
function Dashboard() {
  ...
  var [isRegistrationFormModalOpen, toggleRegistrationFormModal] =
    useState(false);
    ...
    <div className="dashboard">
      <div className="container">
        ...
        >
          ...
          <Modal.Body>{<RegistrationForm />}</Modal.Body>
        </Modal>
        ...
        <div className="row top-buffer">
          <div className="col-12 my-2">
            <button
              onClick={register_btn_click_handler}
              className="home_btn_register float-right"
            >
              Add Company
            </button>
          </div>
          <div className="col-12 col-md-9 col-lg-9 col-xl-9  offset-xl-3  offset-lg-3 offset-md-3 offset-0 card">
            <div className="card-body">
              ...
              <div className="row justify-content-center subheader">
                <div className="col-3" style={{ fontSize: fontSizeValue }}>
                  Plan Name{" "}
                </div>
                <div className="col-3" style={{ fontSize: fontSizeValue }}>
                  Start Date
